...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit User', true), array('action' => 'edit', $user['User']['cid'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete User', true), array('action' => 'delete', $user['User']['cid']), null, sprintf(__('Are you sure you want to delete # %s?', true), $user['User']['cid'])); ?> </li>
