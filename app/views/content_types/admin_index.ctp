<div class="contentTypes index">
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $contentType['ContentType']['id']; ?>&nbsp;</td>
		<td><?php echo $contentType['ContentType']['name']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $contentType['ContentType']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $contentType['ContentType']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $contentType['ContentType']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $contentType['ContentType']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
